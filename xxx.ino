...
void handleSetJadwal() {
  ...
  // Reset hanya flag kloter yang diubah
  // JANGAN reset lastMinute — agar tidak memicu re-evaluasi
  // yang bisa langsung menjalankan servo di menit saat ini
  if (k == 1) done1 = false;
  if (k == 2) done2 = false;
  if (k == 3) done3 = false;
