...
void loop() {
  ...
  // ==============================
  // TRIGGER JADWAL (ADA WINDOW 5 DETIK)
  // ==============================
  if (timeOk && !manualOverride) {
  ...
  // ==============================
  // KEMBALI KE MODE JAM (10 DETIK)
  // ==============================
  if (currentMode == MODE_ALARM &&
      millis() - alarmStart > 10000) {
  ...
  // ==============================
  // TIMER LED PUTIH (20 DETIK)
  // ==============================
  if (ledPutihAktif &&
      millis() - ledPutihStart >= 20000) {
  ...
  // ==============================
  // TIMER LED MERAH (10 DETIK)
  // ==============================
  if (ledMerahAktif &&
      millis() - ledMerahStart >= 10000) {
